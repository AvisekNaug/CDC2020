...
# def main():
	...
	# vec_env_cls = SubprocVecEnv  #  A custom `VecEnv` class constructor. Default: DummyVecEnvSubprocVecEnv 
	...
	# 	monitor_dir = '../log/Trial_{}/Interval_{}/'.format(0,i+1)  # Path to a folder where the monitor files will be saved
